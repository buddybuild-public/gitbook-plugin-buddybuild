...
print "Checking for repeated words in '$dir'... ";
BB::DEBUG "\n";
...
print color('bold red'), "repeats found!", color('reset'), "\n";
my $count = 0;
...
sub check_alt {
  ...
  BB::DEBUG "Done checking for repeated words.\n";
  return \%results;
}
...
Scans a directory for '*.adoc' files, checks each file for repeated words,
such as "the the", or "code code", and emits a report of which lines in
which files contain such.
